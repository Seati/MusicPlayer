...
public class Fragment10 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        tab1view=inflater.inflate(R.layout.activity_fragment10, container, false);

        HttpApi.getNew(inflater.getContext(), HttpApi.Appkey, "shishang", new OkHttpWrapper.HttpResultCallBack() {
            @Override
