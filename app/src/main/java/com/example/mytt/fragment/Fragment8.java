...
public class Fragment8 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        tab1view=inflater.inflate(R.layout.activity_fragment8, container, false);

        HttpApi.getNew(inflater.getContext(), HttpApi.Appkey, "keji", new OkHttpWrapper.HttpResultCallBack() {
            @Override
