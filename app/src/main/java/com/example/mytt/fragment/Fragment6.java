...
public class Fragment6 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        tab1view=inflater.inflate(R.layout.activity_fragment6, container, false);

        HttpApi.getNew(inflater.getContext(), HttpApi.Appkey, "tiyu", new OkHttpWrapper.HttpResultCallBack() {
            @Override
