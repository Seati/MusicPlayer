...
public class Fragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        tab1view=inflater.inflate(R.layout.activity_fragment3, container, false);

        HttpApi.getNew(inflater.getContext(), HttpApi.Appkey, "guonei", new OkHttpWrapper.HttpResultCallBack() {
            @Override
