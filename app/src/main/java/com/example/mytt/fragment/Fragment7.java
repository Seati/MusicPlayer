...
public class Fragment7 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        tab1view=inflater.inflate(R.layout.activity_fragment7, container, false);

        HttpApi.getNew(inflater.getContext(), HttpApi.Appkey, "junshi", new OkHttpWrapper.HttpResultCallBack() {
            @Override
