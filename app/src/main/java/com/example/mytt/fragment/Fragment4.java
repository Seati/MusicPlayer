...
public class Fragment4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        tab1view=inflater.inflate(R.layout.activity_fragment4, container, false);

        HttpApi.getNew(inflater.getContext(), HttpApi.Appkey, "guoji", new OkHttpWrapper.HttpResultCallBack() {
            @Override
