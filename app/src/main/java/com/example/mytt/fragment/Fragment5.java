...
public class Fragment5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        tab1view=inflater.inflate(R.layout.activity_fragment5, container, false);

        HttpApi.getNew(inflater.getContext(), HttpApi.Appkey, "yule", new OkHttpWrapper.HttpResultCallBack() {
            @Override
