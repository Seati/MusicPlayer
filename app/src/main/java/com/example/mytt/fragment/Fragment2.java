...
public class Fragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        tab1view=inflater.inflate(R.layout.activity_fragment2, container, false);

        HttpApi.getNew(inflater.getContext(), HttpApi.Appkey, "shehui", new OkHttpWrapper.HttpResultCallBack() {
            @Override
